...
<form class="popover-form" method="post" action="<?= $this->url->href('ProjectConfigColumnGroupController', 'update', array('plugin' => 'ColumnGroup', 'project_id' => $project['id'], 'column_code' => $column['code'])) ?>" autocomplete="off">
